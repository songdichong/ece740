...
@click.argument('net_name', type=click.Choice(['mnist_LeNet', 'fmnist_LeNet', 'cifar10_LeNet', "ResNet_18", 'arrhythmia_mlp',
...
def main(dataset_name, net_name, xp_path, data_path, load_config, load_model, eta,
    ...
    if dataset_name in ('mnist', 'fmnist', 'cifar10'):
        ...
        if dataset_name in ('mnist', 'fmnist'):
            X_all_low = dataset.test_set.data[idx_all_sorted[:180], ...].unsqueeze(1)
            X_all_high = dataset.test_set.data[idx_all_sorted[-180:], ...].unsqueeze(1)
